...
public class FamilyEntityValidator {
  ...
  //US01: Dates before current date
    ...
    //US04:	@BELLA Marriage before divorce SPRINT 2
    //Something isn't compiling here
    public static void marriageBeforeDivorceCheck(FamilyEntity entity, List<ValidationResult> results) {
        ...
        if (entity.Husband != null && entity.Divorce.Date != null) {
            if (entity.Marriage.Date.after(entity.Divorce.Date)) {
                results.add(new ValidationResult("Marriage date must be before Divorce date.", entity, "US04"));
            }
        }
    ...
    //US05: @BELLA Marriage before death : Marriage should occur before death of either spouse
